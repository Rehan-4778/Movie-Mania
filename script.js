  ...
  lastUrl = url;
    fetch(url).then(res => res.json()).then(data => {
        ...
        if(data.results.length !== 0){
            ...
            movies.innerHTML= `<h1 class="no-results">404 Page Not Found</h1>`
        }
    ...
    data.forEach(movie => {
        ...
        movieEl.innerHTML = `
            ...
            <div class="buy-ticket">
              <button class="buy-tickets-btn" id="" onclick='buyTicket(${JSON.stringify(movie)})'>Buy Tickets</button>
            </div>   
...
function buyTicket(id){
  // localStorage.setItem("1", JSON.stringify({name:"habib",date:"2020-8-10"}));
  // alert(typeof(id));
  // alert(typeof(id));
